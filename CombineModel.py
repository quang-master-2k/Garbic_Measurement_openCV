...
class CombineModel:
    ...
    def cutting_image_2ndMethod(self):
        ...
        eq1 = Eq(-m1*x + 1*y, c1)
        eq2 = Eq(x**2 - 2*x_corner*x + y**2 - 2*y_corner*y, (x_corner - a0[0])**2 + (y_corner - a0[1])**2 - x_corner**2 - y_corner**2 + 450**2)
        ...
        # Define the equations
        eq3 = Eq(-m2*x + 1*y, c2)
        eq4 = Eq(x**2 - 2*x_corner*x + y**2 - 2*y_corner*y, (x_corner - a5[0])**2 + (y_corner - a5[1])**2 - x_corner**2 - y_corner**2 + 450**2)
